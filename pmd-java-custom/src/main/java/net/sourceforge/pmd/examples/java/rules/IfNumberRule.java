...
public class IfNumberRule extends AbstractJavaMetricsRule {

    private static final Logger LOG = Logger.getLogger(IfNumberRule.class.getName());
    ...
    private static final Map<String, CycloMetric.CycloOption> OPTION_MAP;
